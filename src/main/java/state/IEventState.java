...
public interface IEventState {
     ...
     * @param tags                collection of event tags
    ...
    EventTag createEventTag(String tagName, Set<String> tagValues, String defaultTagValue);

    //Boolean areTagsValid(EventTagCollection tags);
}
