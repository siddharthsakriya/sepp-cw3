...
/**
 * {@link ConsoleView} implements the command line interface with which the {@link model.User} interacts with the system.
 */
...
public class ConsoleView implements IView {
    ...
    public static final int STAFF_SAVE_APP_STATE = 7;
    public static final int STAFF_LOAD_APP_STATE = 8;
    ...
    public void displayConsumerMenu() {
        ...
        System.out.println("[" + CONSUMER_MENU_LIST_EVENTS_MAX_DISTANCE + "] ListEventMaxDistanceCommand");
    ...
    public void displayStaffMenu() {
        ...
        System.out.println("[" + STAFF_SAVE_APP_STATE + "] SaveAppStateCommand");
        System.out.println("[" + STAFF_LOAD_APP_STATE + "] LoadAppStateCommand");
